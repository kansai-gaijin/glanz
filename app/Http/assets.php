...
namespace Glanz\Theme\App\Http;
...
use function Glanz\Theme\App\asset_path;
...
add_action('wp_enqueue_scripts', 'Glanz\Theme\App\Http\register_stylesheets');
...
add_action('wp_enqueue_scripts', 'Glanz\Theme\App\Http\register_scripts');
...
add_action('admin_init', 'Glanz\Theme\App\Http\register_editor_stylesheets');
...
add_action('wp_default_scripts', 'Glanz\Theme\App\Http\move_jquery_to_the_footer');
