...
use function Glanz\Theme\App\config;
...
add_action('after_setup_theme', 'Glanz\Theme\App\Setup\add_theme_supports');
...
add_action('after_setup_theme', 'Glanz\Theme\App\Setup\load_textdomain');
