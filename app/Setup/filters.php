...
namespace Glanz\Theme\App\Setup;
...
add_filter('theme/index/sidebar/visibility', 'Glanz\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'Glanz\Theme\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'Glanz\Theme\App\Setup\modify_excerpt_length');
