...
namespace Glanz\Theme\App\Structure;
...
add_action('theme/index/post/thumbnail', 'Glanz\Theme\App\Structure\render_post_thumbnail');
...
add_action('theme/index/content/none', 'Glanz\Theme\App\Structure\render_empty_content');
...
add_action('theme/single/content', 'Glanz\Theme\App\Structure\render_post_content');
...
add_action('theme/index/sidebar', 'Glanz\Theme\App\Structure\render_sidebar');
add_action('theme/single/sidebar', 'Glanz\Theme\App\Structure\render_sidebar');
...
add_action('theme/header/end', 'Glanz\Theme\App\Structure\render_documentation_button');
...
add_action('theme/page/content', 'Glanz\Theme\App\Structure\render_page_content');
...
add_action('theme/header', 'Glanz\Theme\App\Structure\render_header');