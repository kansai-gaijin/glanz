...
<?php
     ...
     *
     * @hooked Glanz\Theme\Index\render_header - 10
     */
    ...
    <div class="wrapper">
        <div class="content">
                ...
                <div class="posts">
                    <?php while (have_posts()) : the_post() ?>
                        <?php
                             ...
                             *
                             * @hooked Glanz\Theme\App\Structure\render_post_thumbnail - 10
                             */
            ...
            <?php else : ?>
                <?php
                     ...
                     *
                     * @hooked Glanz\Theme\App\Structure\render_empty_content - 10
                     */
        ...
        <?php if (apply_filters('theme/index/sidebar/visibility', true)) : ?>
            <?php
                 ...
                 *
                 * @hooked Glanz\Theme\App\Structure\render_sidebar - 10
                 */
